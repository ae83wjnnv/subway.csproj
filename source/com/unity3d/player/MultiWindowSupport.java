...
public class MultiWindowSupport {
    ...
    public static boolean getAllowResizableWindow(Activity activity) {
        try {
            return isInMultiWindowMode(activity) && activity.getPackageManager().getApplicationInfo(activity.getPackageName(), 128).metaData.getBoolean("unity.allow-resizable-window");
