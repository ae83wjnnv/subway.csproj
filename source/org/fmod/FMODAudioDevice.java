    ...
    public void run() {
        ...
        while (this.b) {
            if (!this.d && i2 > 0) {
                ...
                int iFmodGetInfo2 = fmodGetInfo(l) * 2;
                int iRound = Math.round(minBufferSize * 1.1f) & ((iFmodGetInfo2 - 1) ^ (-1));
                int iFmodGetInfo3 = fmodGetInfo(i);
                int iFmodGetInfo4 = fmodGetInfo(j) * iFmodGetInfo3 * iFmodGetInfo2;
